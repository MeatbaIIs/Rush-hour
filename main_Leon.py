...
def main(input_file_name):
    ...
    grid.print_grid()
    #solution = load_solution("data/Rushhour9x9_5_randopt_solution_optimized.csv")
    #solution = load_solution("data/Rushhour6x6_1_solution.csv")
    #solution = grid.route_to_state(solution)
    #print(solution)
    dfs = DepthFirst(grid)#, best_solution = len(solution) - 1, solutions = [solution])
    ...
    print(solution)
    #csv_name = "Rushhour9x9_5_depth.csv"
    #solution_to_csv(solution, csv_name)
    #visual(csv_name, 30)
    # print(solution)
